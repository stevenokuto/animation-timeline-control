...
var TimelineStyleUtils = /*#__PURE__*/function () {
  ...
  timelineStyleUtils_createClass(TimelineStyleUtils, null, [{
     ...
     */
    function getKeyframeStyle(keyframeStyle, rowStyle, options, propertyName, defaultValue) {
...
var TimelineUtils = /*#__PURE__*/function () {
  ...
  timelineUtils_createClass(TimelineUtils, null, [{
    ...
    value: function setMinMax(to, from) {
      ...
      var fromMax = Math.min(from.getMax ? from.getMax() : from.max, from.max);
...
function timelineKeyframeChangedEvent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function timelineTimeChangedEvent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function timelineSelectedEvent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
function timelineSelectedEvent_createSuper(Derived) { var hasNativeReflectConstruct = timelineSelectedEvent_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = timelineSelectedEvent_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = timelineSelectedEvent_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return timelineSelectedEvent_possibleConstructorReturn(this, result); }; }

function timelineSelectedEvent_possibleConstructorReturn(self, call) { if (call && (timelineSelectedEvent_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return timelineSelectedEvent_assertThisInitialized(self); }

function timelineSelectedEvent_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function timelineSelectedEvent_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function timelineSelectedEvent_getPrototypeOf(o) { timelineSelectedEvent_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return timelineSelectedEvent_getPrototypeOf(o); }
...
var TimelineSelectedEvent = /*#__PURE__*/function (_TimelineBaseEvent) {
  timelineSelectedEvent_inherits(TimelineSelectedEvent, _TimelineBaseEvent);

  var _super = timelineSelectedEvent_createSuper(TimelineSelectedEvent);
  ...
  function TimelineSelectedEvent() {
    ...
    timelineSelectedEvent_defineProperty(timelineSelectedEvent_assertThisInitialized(_this), "selected", []);

    timelineSelectedEvent_defineProperty(timelineSelectedEvent_assertThisInitialized(_this), "changed", []);

    return _this;
  }

  return timelineSelectedEvent_createClass(TimelineSelectedEvent);
}(TimelineBaseEvent);
...
function timelineDragEvent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  timeline_createClass(Timeline, [{
        ...
        if (pos) {
          ...
          if (border > 0) {
            if (keyframe.selected) {
              strokeColor = TimelineStyleUtils.keyframeSelectedStrokeColor(keyframe, row, _this8._options);
            } else {
              strokeColor = TimelineStyleUtils.keyframeStrokeColor(keyframe, row, _this8._options);
            }
          }
    ...
    value: function _findDraggable(elements) {
      ...
      var sorted = filteredElements.sort(sortDraggable);
    ...
    value: function _mergeOptions(fromArg) {
      fromArg = fromArg || {}; // Apply incoming options to default. (override default)
      // Deep clone default options:

      var toArg = JSON.parse(JSON.stringify(defaultTimelineOptions)); // Merge options with the default.
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
